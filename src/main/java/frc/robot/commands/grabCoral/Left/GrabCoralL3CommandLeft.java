...
public class GrabCoralL3CommandLeft extends SequentialCommandGroup {
    public GrabCoralL3CommandLeft(CoralSubsystem coralSubsystem, ElevatorSubsystem elevatorSubsystem, Swerve swervesubsystem) {
        super(
                new AlignWithTag(
                        swervesubsystem,
