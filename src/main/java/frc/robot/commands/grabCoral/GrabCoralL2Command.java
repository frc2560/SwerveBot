...
public class GrabCoralL2Command extends SequentialCommandGroup {
    public GrabCoralL2Command(CoralSubsystem coralSubsystem, ElevatorSubsystem elevatorSubsystem, Swerve swervesubsystem) {
