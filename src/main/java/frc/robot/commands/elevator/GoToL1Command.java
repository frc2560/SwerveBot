...
public class GoToL1Command extends Command {
   ...
   @Override
   public void execute() {
      var elevatorSpeed = MathUtil.clamp(elevatorController.calculate(elevatorSubsystem.getPosition(), Constants.ElevatorConstants.FeederPosition), -Constants.ElevatorConstants.DOWNSPEED , Constants.ElevatorConstants.UPSPEED);
