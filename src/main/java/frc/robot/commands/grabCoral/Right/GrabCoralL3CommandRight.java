...
public class GrabCoralL3CommandRight extends SequentialCommandGroup {
    public GrabCoralL3CommandRight(CoralSubsystem coralSubsystem, ElevatorSubsystem elevatorSubsystem, Swerve swervesubsystem) {
        super(
                new AlignWithTag(
                        swervesubsystem,
